...
#------------------------------------------------------------------------------------
Feature: F04-Validating the Billing for WELL Health Safety
    #Scenario-1
    @RegressionTest
    Scenario:Billing page validation for India
    ...
    #Scenario-2
    @RegressionTest
    Scenario:Receipt page validation for India
    ...
    #Scenario-3
    @RegressionTest
    Scenario:Billing page validation for China
        Given User navigate to Dashboard page by logging in to wellcertified
        When User clicks on Billing tab
        Then User will be redirected to the WELL Health-Safety Billing page successfully
    ...
    Scenario:Receipt page validation for India
        ...
        And User verifies Download receipt
        And User verifies WELL logo on the Receipt page
        And User verifies China country name on the Receipt page
        And User verifies WELL Address for China on the Receipt page
        And User verifies  Enrollment Fee for china on the Receipt page
        And User verifies Owner Name on the Receipt page
        And User verifies Owner Email on the Receipt page
